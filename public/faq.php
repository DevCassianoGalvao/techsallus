...
$_faqs = [
    ...
    [
        tx('A solução também controla estoque e farmácia?', 'Does the solution also control inventory and pharmacy?', '¿La solución también controla inventario y farmacia?'),
        tx('Sim. Para clínicas e hospitais, o escopo pode incluir compras, estoque, farmácia, lotes, etiquetagem e integrações de dispensação ou automação.', 'Yes. For clinics and hospitals, scope can include purchasing, inventory, pharmacy, batches, labeling and dispensing or automation integrations.', 'Sí. Para clínicas y hospitales, el alcance puede incluir compras, inventario, farmacia, lotes, etiquetado e integraciones de dispensación o automatización.'),
    ],
    [
        tx('Como a TechSallus ajuda na gestão de custos?', 'How does TechSallus help with cost management?', '¿Cómo ayuda TechSallus en la gestión de costos?'),
        tx('O Apure Custos consolida produção, materiais, pessoal, depreciação, custos gerais e repasses para analisar custos e resultados por especialidade, paciente, unidade, produto e procedimento.', 'Apure Custos consolidates production, materials, personnel, depreciation, overhead and payouts to analyze costs and results by specialty, patient, unit, product and procedure.', 'Apure Custos consolida producción, materiales, personal, depreciación, costos generales y repartos para analizar costos y resultados por especialidad, paciente, unidad, producto y procedimiento.'),
    ],
    [
        tx('É possível integrar com sistemas que a instituição já utiliza?', 'Is it possible to integrate with systems the institution already uses?', '¿Es posible integrar con sistemas que la institución ya utiliza?'),
...
<section class="page-hero">
  ...
  <div class="container">
    <div class="page-hero-inner">
      <h1 class="hero-headline"><?= tx('Perguntas frequentes', 'Frequently asked questions', 'Preguntas frecuentes') ?></h1>
    </div>
  </div>
</section>
...
<section class="page-section">
  <div class="container">
    <h2 class="page-section-heading"><?= tx('Dúvidas sobre a solução', 'Questions about the solution', 'Dudas sobre la solución') ?></h2>
    <div class="faq-list" id="faq-list">
      <?php foreach ($_faqs as $_i => $_faq): ?>
        <div class="faq-item">
          <button class="faq-question" type="button" aria-expanded="false">
            <span><?= $_faq[0] ?></span>
            <svg class="faq-chevron" width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true"><path d="M4 6l4 4 4-4" stroke="#4a6080" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </button>
          <div class="faq-answer"><p><?= $_faq[1] ?></p></div>
        </div>
      <?php endforeach; ?>
    </div>
  </div>
...
<section class="cta-bar">
  <div class="container">
    <div class="cta-bar-actions"><a href="/contato" class="btn-primary"><?= tx('Ainda tenho uma dúvida', 'I still have a question', 'Todavía tengo una duda') ?></a></div>
  </div>
</section>
...
<script>
document.querySelectorAll('#faq-list .faq-question').forEach(function (btn) {
